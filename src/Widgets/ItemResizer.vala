...
public class GtkCanvas.ItemResizer {
    ...
    private unowned GtkCanvas.Item? item = null;
    private bool updating = false;

    private GtkCanvas.Item grabber[9];
    ...
    */
    ...
    /**
    * Creates the widgets needed to re-size {@link GtkCanvas.Item}.
    *
    ...
    * @return a {@link GtkCanvas.Item} or subclass of it
    */
    public virtual GtkCanvas.Item create_grabber (int id) {
    ...
    private GtkCanvas.Item make_grabber (int id) {
    ...
    /**
    * Positions the resize grabbers around a {@link GtkCanvas.Item}
    *
    * @param item the canvas item it will position around
    */
    public void select_item (GtkCanvas.Item item) {
        if (!enabled) return;
